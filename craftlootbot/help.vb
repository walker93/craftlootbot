...
Module help
    ...
    Sub init_help()
        With help_builder
            ...
            .AppendLine("> `/creanegozi <rarità>` o `/creanegozi <rarità> <oggetto/i>` per ricevere dei comandi /negozio da inoltrare a @lootplusbot, la rarità è opzionale.")
        ...
        With creanegozi_builder
            ...
            .AppendLine("E' possibile specificare una rarità da filtrare per ottenere solo gli oggetti di quella rarità.")
            .AppendLine("Se la rarità è seguita (senza spazi) da un asterisco o si antepone l'asterisco senza specificare la rarità, si applicherà un filtro aggiuntivo restituendo solo oggetti craftabili.")
            .AppendLine("Esempi:")
            .AppendLine("`/creanegozi ` -> tutti gli oggetti nello zaino, di tutte le rarità craftabili e non.")
            .AppendLine("`/creanegozi R ` -> tutti gli oggetti R, craftabili e non")
            .AppendLine("`/creanegozi * ` -> tutti gli oggetti craftabili di qualsiasi rarità")
            .AppendLine("`/creanegozi R* ` -> tutti gli oggetti R craftabili")
            .AppendLine("`/creanegozi rivestimento elastico` -> solo oggetti non necessari al craft dell'oggetto inserito")
            .AppendLine("`/creanegozi R rivestimento elastico` -> solo oggetti R non necessari al craft dell'oggetto inserito")
            .AppendLine("`/creanegozi * rivestimento elastico` -> solo oggetti craftabili non necessari al craft dell'oggetto inserito")
            .AppendLine("`/creanegozi R* rivestimento elastico` -> solo oggetti R craftabili non necessari al craft dell'oggetto inserito")
            .AppendLine()
